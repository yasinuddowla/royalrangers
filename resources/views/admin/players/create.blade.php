                    ...
                    <form method="POST" action="{{ route('admin.players.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="trouser_size" 
                                ...
                                <option value="28" {{ old('trouser_size') == '28' ? 'selected' : '' }}>28</option>
                                <option value="30" {{ old('trouser_size') == '30' ? 'selected' : '' }}>30</option>
                                <option value="32" {{ old('trouser_size') == '32' ? 'selected' : '' }}>32</option>
                                <option value="34" {{ old('trouser_size') == '34' ? 'selected' : '' }}>34</option>
                                <option value="36" {{ old('trouser_size') == '36' ? 'selected' : '' }}>36</option>
                                <option value="38" {{ old('trouser_size') == '38' ? 'selected' : '' }}>38</option>
                                <option value="40" {{ old('trouser_size') == '40' ? 'selected' : '' }}>40</option>
                                <option value="42" {{ old('trouser_size') == '42' ? 'selected' : '' }}>42</option>
                                <option value="44" {{ old('trouser_size') == '44' ? 'selected' : '' }}>44</option>
                            </select>
