                    ...
                    <form method="POST" action="{{ route('admin.team-members.update', $teamMember) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="jersey_name" 
                                          ...
                                          type="text" 
                                          name="jersey_name" 
                                          :value="old('jersey_name', $teamMember->jersey_name)" 
                                          required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="jersey_number" 
                                          ...
                                          type="number" 
                                          name="jersey_number" 
                                          :value="old('jersey_number', $teamMember->jersey_number)" 
                                          required />
                        ...
                        <div class="mb-4">
                            ...
                            <select id="jersey_size" 
                                ...
                                <option value="XS" {{ old('jersey_size', $teamMember->jersey_size) == 'XS' ? 'selected' : '' }}>XS</option>
                                <option value="S" {{ old('jersey_size', $teamMember->jersey_size) == 'S' ? 'selected' : '' }}>S</option>
                                <option value="M" {{ old('jersey_size', $teamMember->jersey_size) == 'M' ? 'selected' : '' }}>M</option>
                                <option value="L" {{ old('jersey_size', $teamMember->jersey_size) == 'L' ? 'selected' : '' }}>L</option>
                                <option value="XL" {{ old('jersey_size', $teamMember->jersey_size) == 'XL' ? 'selected' : '' }}>XL</option>
                                <option value="XXL" {{ old('jersey_size', $teamMember->jersey_size) == 'XXL' ? 'selected' : '' }}>XXL</option>
                                <option value="XXXL" {{ old('jersey_size', $teamMember->jersey_size) == 'XXXL' ? 'selected' : '' }}>XXXL</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="trouser_size" 
                                ...
                                <option value="28" {{ old('trouser_size', $teamMember->trouser_size) == '28' ? 'selected' : '' }}>28</option>
                                <option value="30" {{ old('trouser_size', $teamMember->trouser_size) == '30' ? 'selected' : '' }}>30</option>
                                <option value="32" {{ old('trouser_size', $teamMember->trouser_size) == '32' ? 'selected' : '' }}>32</option>
                                <option value="34" {{ old('trouser_size', $teamMember->trouser_size) == '34' ? 'selected' : '' }}>34</option>
                                <option value="36" {{ old('trouser_size', $teamMember->trouser_size) == '36' ? 'selected' : '' }}>36</option>
                                <option value="38" {{ old('trouser_size', $teamMember->trouser_size) == '38' ? 'selected' : '' }}>38</option>
                                <option value="40" {{ old('trouser_size', $teamMember->trouser_size) == '40' ? 'selected' : '' }}>40</option>
                                <option value="42" {{ old('trouser_size', $teamMember->trouser_size) == '42' ? 'selected' : '' }}>42</option>
                                <option value="44" {{ old('trouser_size', $teamMember->trouser_size) == '44' ? 'selected' : '' }}>44</option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="whatsapp_link" 
                                          ...
                                          type="url" 
                                          name="whatsapp_link" 
                                          :value="old('whatsapp_link', $teamMember->whatsapp_link)" 
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="facebook_link" 
                                          ...
                                          type="url" 
                                          name="facebook_link" 
                                          :value="old('facebook_link', $teamMember->facebook_link)" 
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="cricheroes_profile_link" 
                                          ...
                                          :value="old('cricheroes_profile_link', $teamMember->cricheroes_profile_link)" 
